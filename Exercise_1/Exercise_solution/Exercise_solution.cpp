...
int main(int ac, char** av)
{
	...
	cv::createTrackbar("Threshold", "Exercise 4 - Converted Image", &slider_value, 255, trackbarHandler, &slider_value);

	// Added in Exercise 4 - Start *****************************************************************
	int bw_sileder_value = bw_thresh;
	cv::createTrackbar("BW Threshold", "Exercise 4 - Converted Image", &slider_value, 255, bw_trackbarHandler, &bw_sileder_value);
	// Added in Exercise 4 - End *******************************************************************
