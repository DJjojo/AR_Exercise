...
int main(int ac, char** av)
{
	...
	cv::VideoCapture cap;
	const std::string kWinName1 = "Exercise 5 - Original Image";
	const std::string kWinName2 = "Exercise 5 - Converted Image";
	const std::string kWinName3 = "Exercise 5 - Stripe Image";
	const std::string kWinName4 = "Exercise 5 - Marker";
	...
	while (1) {
		...
		cv::threshold(img_gray, img_mono, slider_value, 255, CV_THRESH_BINARY);
		...
		for (; contours; contours = contours->h_next)
		{
			...
			for (int i = 0; i<4; ++i)
			{
				...
				cv::fitLine(mat, lineParamsMat, CV_DIST_L2, 0, 0.01, 0.01);
